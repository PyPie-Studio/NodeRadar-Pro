...
public class PortScansPage : Border
{
    ...
    public PortScansPage()
    {
        ...
        // Header
        var label = new TextBlock { Text = "PORT RECONNAISSANCE", FontSize = 13, FontWeight = FontWeight.Bold, Foreground = ThemeTokens.NavAccentBorder, FontFamily = ThemeTokens.DefaultFont, LetterSpacing = 2.5, Margin = new Thickness(0, 0, 0, 8) };
        ...
        _progressPct = new TextBlock { Text = "0%", FontSize = 14, FontWeight = FontWeight.Bold, Foreground = ThemeTokens.Primary, FontFamily = ThemeTokens.DefaultFont };
        var progLabel = new TextBlock { Text = "Progress", FontSize = 14, Foreground = ThemeTokens.OnSurfaceVariant, FontFamily = ThemeTokens.DefaultFont, FontWeight = FontWeight.Medium };
    ...
    private Border MakeProfileChip(string name, string start, string end, string tooltip)
    {
        var chip = new Border
        {
            ...
            BorderThickness = new Thickness(1),
            Cursor = new Avalonia.Input.Cursor(Avalonia.Input.StandardCursorType.Hand),
            Child = new TextBlock { Text = name, FontSize = 14, Foreground = ThemeTokens.OnSurfaceVariant, FontFamily = ThemeTokens.DefaultFont, FontWeight = FontWeight.Medium }
        };
    ...
    private static Border MakeTableHeader()
    {
        ...
        return new Border { Background = ThemeTokens.SurfaceTableRow, Padding = new Thickness(0, 14), Child = grid };
    }
    ...
    private static Border MakeResultRow(int port, string ip, bool alt)
    {
        ...
        var portTb = new TextBlock { Text = port.ToString(), FontSize = 15, Foreground = isRisky ? ThemeTokens.Error : ThemeTokens.Primary, FontFamily = ThemeTokens.DefaultFont, FontWeight = FontWeight.SemiBold, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(16, 0) };
        var svcTb = new TextBlock { Text = PortScanner.GetServiceName(port), FontSize = 15, Foreground = ThemeTokens.OnSurface, FontFamily = ThemeTokens.DefaultFont, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(16, 0) };
        var protoTb = new TextBlock { Text = "TCP", FontSize = 14, Foreground = ThemeTokens.OnSurfaceVariant, FontFamily = ThemeTokens.DefaultFont, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(16, 0) };

        var badgeBg = isRisky ? ThemeTokens.ErrorContainer : ThemeTokens.TertiaryContainerSubtle;
        var badgeFg = isRisky ? ThemeTokens.Error : ThemeTokens.Tertiary;
        var stateBadge = new Border { Background = badgeBg, CornerRadius = new CornerRadius(4), Padding = new Thickness(10, 4), VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(16, 0), Child = new TextBlock { Text = isRisky ? "Risk" : "Open", FontSize = 13, Foreground = badgeFg, FontFamily = ThemeTokens.DefaultFont, FontWeight = FontWeight.Medium } };
